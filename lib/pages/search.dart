...
//       String username, String groupId, String groupname, String admin) async {
//     await DataBaseService(uid: user!.uid)
//         .isuUserJoined(groupname, groupId, username)
//         .then((value) {
//       setState(() {
//         isJoined = true;
//       });
...
//         onTap: () async {
//           await DataBaseService(uid: user!.uid)
//               .toggleGroupButton(groupId, groupName, userName);
//           if (isJoined) {
//             setState(() {
//               isJoined = !isJoined;
//             });
